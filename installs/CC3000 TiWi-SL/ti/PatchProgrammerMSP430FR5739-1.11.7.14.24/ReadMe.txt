...
1) Patch Programmer source
   ...
   1.2) DR Patch Programmer - patch program utility workspace for CCS v5.3 environment
   1.3) FW Patch Programmer - patch program utility workspace for CCS v5.3 environment
   1.4) DR Patch Programmer - IAR patch program utility workspace for IAR v5.51.4 environment
   1.5) FW Patch Programmer - IAR patch program utility workspace for IAR v5.51.4 environment
